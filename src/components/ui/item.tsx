...
const itemVariants = cva(
  "[a]:hover:bg-muted rounded-none border text-xs w-full group/item focus-visible:border-ring focus-visible:ring-ring/50 flex items-center flex-wrap outline-none focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        default: "border-transparent",
        outline: "border-primary bg-white",
