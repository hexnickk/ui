...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-2.5 font-semibold uppercase data-[variant=label]:text-xs data-[variant=legend]:text-sm",
        className,
      )}
      {...props}
    />
...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "has-data-checked:bg-primary/5 has-data-checked:border-primary gap-2 group-data-[disabled=true]/field:opacity-50 has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border has-[>[data-slot=field]]:border-primary [&>*]:data-[slot=field]:p-2 group/field-label peer/field-label flex w-fit leading-snug",
